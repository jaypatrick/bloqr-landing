  ...
  vite: {
    server: {
      headers: {
        ...
        'Content-Security-Policy': "default-src 'self'; style-src 'self' 'unsafe-inline'; font-src 'self'; script-src 'self' 'unsafe-inline' https://static.cloudflareinsights.com; connect-src 'self' ws: wss: https://app.posthog.com https://plausible.io https://cloudflareinsights.com; img-src 'self' data:;",
      }
    }
  }
});
