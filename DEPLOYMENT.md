...
| `BETTER_AUTH_URL` | The canonical URL of this app, e.g. `https://adblock-landing.jayson-knight.workers.dev` (update to `https://bloqr.ai` when live) |
...
3. Homepage URL: `https://adblock-landing.jayson-knight.workers.dev` (update to `https://bloqr.ai` when live)
4. Authorization callback URL: `https://adblock-landing.jayson-knight.workers.dev/api/auth/callback/github`
...
```typescript
const sessionRes = await fetch('https://adblock-landing.jayson-knight.workers.dev/api/auth/session', {
